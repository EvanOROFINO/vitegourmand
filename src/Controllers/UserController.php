...
final class UserController extends Controller
{
    ...
    {
        Auth::requireLogin();
        $commandes = CommandeRepository::findByUser((int) Auth::id());
    ...
    public function updateProfil(): void
    {
        ...
        UserRepository::update((int) Auth::id(), $data);
    ...
    public function commandeDetail(string $numero): void
    {
        ...
        $this->view('user/commande-detail', [
            ...
            'commande'   => $commande,
            'historique' => CommandeRepository::historique($numero),
            'avis'       => AvisRepository::findByCommande($numero),
        ]);
    }
    ...
    public function annulerCommande(string $numero): void
    {
        ...
        CommandeRepository::annuler($numero, (string) $motif, 'client');
    ...
    public function modifierCommande(string $numero): void
    {
        ...
        $menu = MenuRepository::find((int) $commande['menu_id']);
        ...
        $prix        = CommandeRepository::calculerPrix($menu, $nbPersonnes, (string) $ville, $distance);

        CommandeRepository::modifier($numero, [
    ...
    public function showAvisForm(string $numero): void
    {
        ...
        if (AvisRepository::findByCommande($numero)) {
    ...
    public function submitAvis(string $numero): void
    {
        ...
        // Délégation au service métier (validation note + commentaire)
        try {
            (new \App\Services\AvisService())->creerAvis((int) Auth::id(), $numero, $note, $description);
